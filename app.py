...
def summarize_image(image, language):
    prompt = {
        ...
        "te": [
            ...
            "పరిచయ పదాలు, ఆమోద వ్యాఖ్యలు లేదా అనవసరమైన వాక్యాలు ఉపయోగించవద్దు.",
    ...
    if language == "te":
        unwanted_phrases = [
            "ఖచ్చితంగా,", 
            "ఇక్కడ చిత్రం యొక్క సంక్షిప్త వివరణ ఉంది:", 
            "ఇది చిత్రం యొక్క వివరణ:", 
            "ఇది మీకు కావలసిన వివరణ:"
        ]
        for phrase in unwanted_phrases:
            if summary.startswith(phrase):
                summary = summary.replace(phrase, "").strip()

    # Similar cleanup for Hindi (optional)
    elif language == "hi":
        unwanted_phrases = [
            "ज़रूर,", 
            "यहाँ छवि का संक्षिप्त विवरण है:", 
            "यह है छवि का विवरण:"
        ]
        for phrase in unwanted_phrases:
            if summary.startswith(phrase):
